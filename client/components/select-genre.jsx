...
import { genreReady, genreUnready, grabSpotifyReccomendations } from '../redux/actions/genreActions';
...
class SelectGenre extends React.Component {
  ...
  sendUserGenres() {
    const userData = {
      ...
      genres: this.state.checked
    };
    // this.props.grabSpotifyReccomendations()
...
export default connect(mapStateToProps, { genreReady, genreUnready, grabSpotifyReccomendations })(SelectGenre);
