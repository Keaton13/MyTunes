...
import { grabSpotifyCurrentlyPlaying } from '../redux/actions/spotifyActions'
...
class Player extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.grabSpotifyCurrentlyPlaying(this.props.token);
    }
...
Player.PropTypes = {
    grabSpotifyCurrentlyPlaying: PropTypes.func.isRequired
}
...
export default connect(mapStateToProps, { grabSpotifyCurrentlyPlaying })(Player);
